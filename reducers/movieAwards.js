...
const byId = (state={}, action) => {
  switch (action.type) {
    case types.FETCH_MOVIE_AWARDS_COMPLETED: {
    ...
    case types.ADD_MOVIE_AWARD_STARTED: {
      const newState = { ...state };
    ...
    case types.ADD_MOVIE_AWARD_COMPLETED: {
    ...
    case types.REMOVE_MOVIE_AWARD_STARTED: {
...
const isFetching = (state=false , action) => {
  switch (action.type) {
    case types.FETCH_MOVIE_AWARDS_STARTED: {
      return true;
    }
    case types.FETCH_MOVIE_AWARDS_COMPLETED: {
      return false;
    }
    case types.FETCH_MOVIE_AWARDS_FAILED: {
      return false;
    }
    default: {
      return state;
...
const error = (state=null , action) => {
  switch (action.type) {
    ...
    case types.ADD_MOVIE_AWARD_COMPLETED:
    case types.REMOVE_MOVIE_AWARD_STARTED:
    case types.REMOVE_MOVIE_AWARD_COMPLETED:
      return null;
    case types.FETCH_MOVIE_AWARDS_FAILED:
    case types.ADD_MOVIE_AWARD_FAILED:
    case types.REMOVE_MOVIE_AWARD_FAILED:
