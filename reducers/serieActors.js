...
const byId = (state = {}, action) => {
    switch (action.type) {
        case types.FETCH_SERIE_ACTORS_COMPLETED: {
        ...
        case types.ADD_SERIE_ACTORS_STARTED: {
            const newState = { ...state };
        ...
        case types.ADD_SERIE_ACTORS_COMPLETED: {
        ...
        case types.REMOVE_SERIE_ACTORS_STARTED: {
...
const isFetching = (state = false, action) => {
    switch (action.type) {
        case types.FETCH_SERIE_ACTORS_STARTED: {
            return true
        }
        case types.FETCH_SERIE_ACTORS_COMPLETED: {
            return false
        }
        case types.FETCH_SERIE_ACTORS_FAILED: {
            return false
        }
        default: {
            return state
...
const error = (state = null, action) => {
    switch (action.type) {
        ...
        case types.ADD_SERIE_ACTORS_COMPLETED:
        case types.REMOVE_SERIE_ACTORS_STARTED:
        case types.REMOVE_SERIE_ACTORS_COMPLETED:
            return null;
        case types.FETCH_SERIE_ACTORS_FAILED:
        case types.ADD_SERIE_ACTORS_FAILED:
        case types.REMOVE_SERIE_ACTORS_FAILED:
